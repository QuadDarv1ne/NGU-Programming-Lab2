 ...
 */
 ...
 /*
 * BN_new()
 * Назначение: Создает новый объект BIGNUM (большое число).
 * 
 * BN_free(BIGNUM* a)
 * Назначение: Освобождает память, занятую объектом BIGNUM.
 * 
 * BN_generate_prime_ex()
 * Назначение: Генерирует простое число заданного размера.
 */
